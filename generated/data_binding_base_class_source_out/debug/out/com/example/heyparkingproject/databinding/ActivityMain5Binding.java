...
public final class ActivityMain5Binding implements ViewBinding {
  ...
  private ActivityMain5Binding(@NonNull ConstraintLayout rootView, @NonNull Button button2,
      @NonNull Button button3, @NonNull ImageView imageView12) {
  ...
  public static ActivityMain5Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMain5Binding((ConstraintLayout) rootView, button2, button3, imageView12);
    }
